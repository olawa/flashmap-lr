...
pub struct ReadDiagnostics {
    ...
    pub chains: u32,
    pub dp_calls: u32,
    pub dp_cache_hits: u32,
    pub dp_budget_rejections: u32,
    pub dp_impossible_band: u32,
    pub dp_zdrop_rejections: u32,
    pub dp_incomplete_rejections: u32,
    ...
    pub anchor_runs_single_gap_segment_dissolved: u64,
    pub anchor_runs_continuous_cache_hits: u64,
